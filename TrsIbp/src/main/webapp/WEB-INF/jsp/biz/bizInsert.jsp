...
<div class="ds-page-head"><div><h1 class="ds-page-title">사업 등록</h1><p class="ds-page-desc">사업 기본정보와 핵심 계약정보를 등록합니다.</p></div><div class="ds-actions"><a href="${pageContext.request.contextPath}/biz/bizList.do" class="ds-btn ds-btn-outline">목록</a><button type="button" class="ds-btn ds-btn-primary" onclick="saveBiz();">저장</button></div></div>
