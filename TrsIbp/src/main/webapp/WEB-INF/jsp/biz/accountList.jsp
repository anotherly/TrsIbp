...
<div class="flex-grow flex flex-col min-h-screen">
    ...
    <main class="ds-page">
        ...
        <section class="ds-card ds-card-inner">
            <div class="ds-section-head"><div><h2 class="ds-section-title">직접비 및 손익</h2><p class="ds-section-desc">직접비는 별도 입력하고 인건비는 투입인력 M/M와 단가로 계산합니다.</p></div></div>
            ...
            <div class="ds-form-grid ds-mb-20">
                ...
                <div class="ds-field"><label for="frmCstSeCd">비용구분</label><select id="frmCstSeCd" class="ds-select"><option value="">선택</option></select></div>
                <div class="ds-field"><label for="frmCstNm">비용명</label><input type="text" id="frmCstNm" class="ds-input" maxlength="100"></div>
                <div class="ds-field"><label for="frmOcrnCst">발생비용</label><input type="number" id="frmOcrnCst" class="ds-input" min="0" step="1"></div>
                <div class="ds-field"><label for="frmOcrnYmd">발생일자</label><input type="date" id="frmOcrnYmd" class="ds-input"></div>
                <div class="ds-search-actions"><button type="button" class="ds-btn ds-btn-outline ds-btn-full" onclick="resetCstForm();">초기화</button></div>
                <div class="ds-search-actions"><button type="button" class="ds-btn ds-btn-primary ds-btn-full" onclick="saveBizCst();">저장</button></div>
            </div>
            <div class="ds-table-wrap"><table class="ds-table"><thead><tr><th>번호</th><th>구분</th><th>비용명</th><th>금액</th><th>발생일자</th><th>관리</th></tr></thead><tbody id="bizCstBody"></tbody></table></div>
        </section>
    </main>
</div>
